#!/usr/bin/env python3
"""
Auto Claude Status Report Generator
===================================

Generates a comprehensive status report for all specs and roadmap features,
including issue detection and diagnostics.
"""
...
try:
    ...
    # Fallback if status_report module not available
...
def generate_status_report(project_dir: Path) -> dict:
    ...
    Returns:
        Dictionary with summary, specs, roadmap, and issues
    """
